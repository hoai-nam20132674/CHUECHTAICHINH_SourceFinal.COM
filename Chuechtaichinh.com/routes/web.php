...
Route::get('admin/product/categorie/getProperties', 'HomeController@getProperties')->name('getProperties');
...
Route::get('/server.php', 'Controller@serverError')->name('serverError');
...
Route::group(['middleware' => 'locale'], function() {
	...
	Route::get('videos', 'Controller@videos')->name('Authvideos');
