...
@section('head')
    ...
    <meta property="og:image" name="ogimage" content="{{asset('uploads/images/products/categories/'.$categorie->avata)}}" />
                                                           ...
                                                           <span class='special-price'>
                                                              <span class='price-container'>
                                                                 <span class='price-wrapper'>
                                                                    @if($item->price != 0)
                                                                       @if($item->sale == null)
                                                                          <span class='price product-price'>{!!number_format($item->price)!!}<span class='dvtt'>@if($item->tiente == 0) đ @else $ @endif </span></span>
                                                                       @else
                                                                          <span class='price product-price'>{!!number_format($item->sale)!!}<span class='dvtt'>@if($item->tiente == 0) đ @else $ @endif</span></span>

                                                                          <del class="price product-price-old">{!!number_format($item->price)!!}<span class="dvtt">@if($item->tiente == 0) đ @else $ @endif</span></del>
                                                                       @endif
                                                                    @else
