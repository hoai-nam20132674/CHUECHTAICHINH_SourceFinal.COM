                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="footer-widget">
                        <div class="logo logo-dark">
                            <a href="index.html">
                                <img src="https://rainbowit.net/html/histudy/assets/images/logo/logo.png" alt="Edu-cause">
                            </a>
                        </div>
                        <div class="logo d-none logo-light">
                            <a href="index.html">
                                <img src="https://rainbowit.net/html/histudy/assets/images/dark/logo/logo-light.png" alt="Edu-cause">
                            </a>
                        </div>
