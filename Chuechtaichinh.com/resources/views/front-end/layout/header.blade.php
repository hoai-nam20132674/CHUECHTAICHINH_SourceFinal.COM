                            ...
                            <div class="rbt-header-top-news">
                                <div class="inner">
                                    <div class="content">
                                        ...
                                        <span class="news-text"><img src="https://rainbowit.net/html/histudy/assets/images/icons/hand-emojji.svg" alt="Hand Emojji Images"> Intro price. Get Histudy for Big Sale -95% off.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="header-info">
                            <ul class="rbt-dropdown-menu switcher-language">
                                <li class="has-child-menu">
                                    <a href="#">
                                        <img class="left-image" src="https://rainbowit.net/html/histudy/assets/images/icons/en-us.png" alt="Language Images">
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="#">
                                                <img class="left-image" src="https://rainbowit.net/html/histudy/assets/images/icons/fr.png" alt="Language Images">
                                                <span class="menu-item">Français</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <img class="left-image" src="https://rainbowit.net/html/histudy/assets/images/icons/de.png" alt="Language Images">
            ...
            <div class="header-left rbt-header-content">
                <div class="header-info">
                    <div class="logo logo-dark">
                        <a href="index.html">
                            <img src="https://rainbowit.net/html/histudy/assets/images/logo/logo.png" alt="Education Logo Images">
                        </a>
                    </div>

                    <div class="logo d-none logo-light">
                        <a href="index.html">
                            <img src="https://rainbowit.net/html/histudy/assets/images/dark/logo/logo-light.png" alt="Education Logo Images">
                        </a>
                    </div>
                </div>
                ...
                <nav class="mainmenu-nav">
                    <ul class="mainmenu">
                        ...
                        <li class="with-megamenu has-menu-child-item position-static">
                            <a href="#">KHÓA HỌC <i class="feather-chevron-down"></i></a>
                            <!-- Start Mega Menu  -->
                                    ...
                                    <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="01-main-demo.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h1.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="12-marketplace.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h12.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="04-kindergarten.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h4.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="13-university-classic.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h13.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="14-home-elegant.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h14.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="09-gym-coaching.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h9.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="03-online-school.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h3.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="06-university-status.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h6.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="15-home-technology.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h15.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="07-instructor-portfolio.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h7.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="08-language-academy.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h8.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="11-single-course.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h11.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="10-online-course.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h10.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="05-classic-lms.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h5.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="02-course-school.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h2.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="16-udemy-affiliate.html"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/h16.jpg" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item coming-soon">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="#"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/coming-soon-1.png" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item coming-soon">
                                            <div class="demo-single">
                                                <div class="inner">
                                                    <div class="thumbnail">
                                                        <a href="#"><img src="https://rainbowit.net/html/histudy/assets/images/splash/demo/coming-soon-2.png" alt="Demo Images"></a>
                                                    </div>
                                                    <div class="content">
                        ...
                        <li class="">
                            <a href="#">KIẾN THỨC ĐẦU TƯ
                            </a>
                        
                        </li>
                        <li class="">
                            <a href="#">TƯ DUY LÀM GIÀU
                            </a>
                                ...
                                <div class="inner">
                                    <div class="rbt-admin-profile">
                                        <div class="admin-thumbnail">
                                            <img src="https://rainbowit.net/html/histudy/assets/images/team/avatar.jpg" alt="User Images">
                                        </div>
                                        <div class="admin-info">
                                            <span class="name">Fazlay Elahi Rafi</span>
            ...
            <div class="row g-4 pt--30 pb--60">
                    ...
                    <div class="rbt-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="course-details.html">
                                <img src="https://rainbowit.net/html/histudy/assets/images/course/course-online-01.jpg" alt="Card image">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="rbt-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="course-details.html">
                                <img src="https://rainbowit.net/html/histudy/assets/images/course/course-online-03.jpg" alt="Card image">
                            </a>
                        </div>
                        <div class="rbt-card-body">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="rbt-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="course-details.html">
                                <img src="https://rainbowit.net/html/histudy/assets/images/course/course-online-04.jpg" alt="Card image">
                            </a>
                        </div>
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.html">Web Design</a>
