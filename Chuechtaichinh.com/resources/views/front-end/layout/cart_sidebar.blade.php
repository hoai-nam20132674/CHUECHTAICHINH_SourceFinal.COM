        ...
        <nav class="side-nav w-100">
            <ul class="rbt-minicart-wrapper">
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="https://rainbowit.net/html/histudy/assets/images/product/1.jpg" alt="Product Images">
                        </a>
                    </div>
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="https://rainbowit.net/html/histudy/assets/images/product/7.jpg" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="https://rainbowit.net/html/histudy/assets/images/product/3.jpg" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="https://rainbowit.net/html/histudy/assets/images/product/4.jpg" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
