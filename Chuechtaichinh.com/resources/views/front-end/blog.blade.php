...
@section('head')
    ...
    <meta property="og:title" name="ogtitle" content="{{$blog->title}}" />

    <meta property="og:description" name="ogdescription" content="{{$blog->seo_description}}" />

    <meta property="og:url" name="ogurl" content="https://cuongluxury.vn/{{$blog->url}}" />

    <meta property="og:image" name="ogimage" content="{{asset('uploads/images/blogs/'.$blog->avata)}}" />

    <meta property="og:image:alt" name="og:image:alt" content="Cuong Luxury" />

    <meta property="og:sitename" content="https://cuongluxury.vn/" />

    <link rel="canonical" href="https://cuongluxury.vn/{{$blog->url}}" />
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <ul class="breadcrumb" itemscope="">
                        ...
                        <li  ><span><i class='fa fa-angle-right'></i> </span><span itemprop='title'><a itemprop='url' href='https://cuongluxury.vn/chuyen-muc-tin-tuc' title='Chuyên mục tin tức'>Chuyên mục tin tức</a></span></li> <li> <span><i class='fa fa-angle-right'></i> </span><strong itemprop='title'>{{$blog->name}}</strong></li>
                                    ...
                                    <ul>
                                        ...
                                        <li class="item">
                                            ...
                                            <a href="/{{$item->url}}" title="{{$item->name}}">
                                                ...
                                                <i class="fa fa-angle-double-right"></i>{{$item->name}}<span class="nd-info" style="padding-left: 5px;">({{ \Carbon\Carbon::parse($item->created_at)->format('d/m/Y')}})</span>
