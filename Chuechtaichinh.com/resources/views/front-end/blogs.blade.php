...
@section('head')
    ...
    <meta property="og:url" name="ogurl" content="https://dienthoaixor.vn/{{$categorie->url}}" />
    ...
    <meta property="og:sitename" content="https://dienthoaixor.vn/" />

    <link rel="canonical" href="https://dienthoaixor.vn/{{$categorie->url}}" />
                                        ...
                                        <article class="blog-item">
                                            ...
                                            <div class="blog-item-thumbnail">
                                                ...
                                                <a href="/{{$item->url}}" title="{{$item->title}}">
                                                    ...
                                                    <img class="image-blog" src="{{asset('uploads/images/blogs/'.$item->avata)}}" alt="{{$item->title}}">
