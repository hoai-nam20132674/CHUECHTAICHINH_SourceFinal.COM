                                ...
                                <div class="btn-group">
                                	...
                                	<ul class="dropdown-menu">
                                        ...
                                        <li>
                                            ...
                                            <a href="#" data-href="{{URL::route('deleteCourses')}}" class="deletes" data-class-item="">Xoá</a>
		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            ...
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		...
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="{{URL::route('addCourse')}}"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
                            	...
                            	<table class="table table-striped table-hover vertical-middle dataTable no-footer" id="table-categories" role="grid" aria-describedby="table-categories_info" style="width: 1582px;">
                            		...
                            		<thead>
										...
										<tr>
											...
											<th  title="Tên" width="300px" class="text-left column-key-name">Tiêu đề</th>
										...
										@foreach($courses as $course)
											...
											@endif
													...
													<td class=" text-left no-sort">
														...
														<div class="text-left">
														    ...
														    <div class="checkbox checkbox-primary table-checkbox">
														        ...
														        <input type="checkbox" class="checkboxes" name="id[]" value="{{$course->id}}">
													...
													<td class="  column-key-image">
														...
														<img src="{{asset('uploads/images/courses/'.$course->avata)}}" width="50" alt="{{$course->name}}">

													</td>

													<td class=" text-left column-key-name"><a href="{{URL::route('editCourse',$course->id)}}" title="{{$course->name}}" >{!! \Illuminate\Support\Str::words($course->name, 8,'...')  !!}</a></td>

													

													<td class=" text-left column-key-name"><a href="">Admin</a></td>
													...
													<td class=" text-center">
														...
														<div class="table-actions">
										                    ...
										                    <a href="/{{$course->url}}" target="_blank" class="btn btn-icon btn-sm btn-primary" data-toggle="tooltip" data-original-title="Xem">

										                    	<i class="fa fa-eye"></i>

										                    </a>

										        			<a href="{{URL::route('editCourse',$course->id)}}" class="btn btn-icon btn-sm btn-primary" data-toggle="tooltip" data-original-title="Sửa">

										                    	<i class="fa fa-edit"></i>

										                    </a>

										                    <a href="#" class="btn btn-icon btn-sm btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteCourse',$course->id)}}" role="button" data-original-title="Xóa bản ghi">
