...
@section('content')
	<div class="page-content ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Dang sách bài giảng</li>
		                    ...
		                    <div class="wrapper-action">
                                <div class="btn-group">
                                	...
                                	<ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="#" data-href="{{URL::route('deleteVideos')}}" class="deletes" data-class-item="">Xoá</a>
                                        </li>
                                    </ul>
                            	</div>
		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="{{URL::route('addLesson')}}"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
                            	...
                            	<table class="table table-striped table-hover vertical-middle dataTable no-footer" id="table-categories" role="grid" aria-describedby="table-categories_info" style="width: 1582px;">
                            		<thead>
										<tr>
											...
											<th  title="Tên" width="200px" class="text-left column-key-name">Tiêu đề</th>
											<th  title="Categories" width="100px" class="no-sort column-key-updated_at">Khóa học</th>
										...
										@foreach($lessons as $lesson)
											...
											@endif
													<td class=" text-left no-sort">
														<div class="text-left">
														    <div class="checkbox checkbox-primary table-checkbox">
														        <input type="checkbox" class="checkboxes" name="id[]" value="{{$lesson->id}}">
														    </div>
														</div>
													</td>
													...
													<td class=" text-left column-key-name">
														@if($lesson->type)
															<span class="label-info status-label"><i class="fa fa-camera" aria-hidden="true"> </i></span>
														
														@endif
														<a href=""> {{$lesson->title}}</a></td>
													
													<td class=" no-sort column-key-updated_at">
														
													</td>
													<td class="  column-key-created_at">{{$lesson->created_at}}</td>
													@if($lesson->status ==1 )
													...
													<td class=" text-center">
														<div class="table-actions">
										                    ...
										                    <a href="{{URL::route('editLesson',$lesson->id)}}" class="btn btn-icon btn-sm btn-primary" data-toggle="tooltip" data-original-title="Sửa">
										                    	<i class="fa fa-edit"></i>
										                    </a>
										        
										                    <a href="#" class="btn btn-icon btn-sm btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteLesson',$lesson->id)}}" role="button" data-original-title="Xóa bản ghi">
