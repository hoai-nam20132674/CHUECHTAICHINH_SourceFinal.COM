...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Chuechtaichinh | Dashboard</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mt-sm-5 mb-4 text-white-50">
                                ...
                                <p class="mt-3 fs-15 fw-medium">QUẢN TRỊ NỘI DUNG WEBSITE CHUECHTAICHINH.VN</p>
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
                        ...
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0 text-muted">&copy;
                                    <script>document.write(new Date().getFullYear())</script> Chuechtaichinh CMS <i class="mdi mdi-heart text-danger"></i> Design by NN
                                </p>
                            </div>
                        </div>
                    </div>
