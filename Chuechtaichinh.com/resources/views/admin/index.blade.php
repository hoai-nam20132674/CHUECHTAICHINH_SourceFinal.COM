...
@section('content')
    ...
    <div id="list_widgets" class="row">
        ...
        <a class="dashboard-stat dashboard-stat-v2" style="background-color: #32c5d2; color: #fff" href="{{URL::route('blogs')}}">
            <div class="visual">
            ...
            <div class="details">
                <div class="number">
                    @php
                        $b = App\Blog::where('lang','vi')->get();
                    @endphp
                    <span data-counter="counterup" data-value="{{count($b)}}">0</span>
                </div>
        ...
        <a class="dashboard-stat dashboard-stat-v2" style="background-color: #8e44ad; color: #fff" href="{{URL::route('products')}}">
            ...
            <div class="details">
                ...
                <div class="desc">Sản phẩm</div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
        <a class="dashboard-stat dashboard-stat-v2" style="background-color: #e7505a; color: #fff" href="{{URL::route('contacts')}}">
            <div class="visual">
            ...
            <div class="details">
                <div class="number">
                    @php
                        $ct = App\Contact::get();
                    @endphp
                    <span data-counter="counterup" data-value="{{count($ct)}}">0</span>
                </div>
            ...
            <div class="details">
                <div class="number">
                    @php
                        $u = App\User::get();
                    @endphp
                    <span data-counter="counterup" data-value="{{count($u)}}">0</span>
                </div>
    ...
    <a href="#" class="remove" data-toggle="tooltip" title="Ẩn"></a>
            ...
            <a style="display: none;" href="#" class="manage-widget"><i class="fa fa-plus"></i> Quản lý tiện ích</a>
