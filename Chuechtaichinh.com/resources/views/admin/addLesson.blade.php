...
@section('content')
	<div class="page-content ">
                    ...
                    <div id="main">
                        <form method="POST" action="{{URL::route('postAddLesson')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                ...
                <div class="main-form">
                    <div class="form-body">
                        ...
                        <div class="form-group"  >
                            ...
                            <input class="form-control" placeholder="Nhập link video" data-counter="120" name="videolink" type="text" required id="videolink">
                        </div>
                        ...
                        <div class="form-group"  >
                            ...
                            <textarea class="form-control" rows="4" placeholder="Nội dung" data-counter="4000" name="content" cols="50" id="content">{{old('url')}}</textarea>
